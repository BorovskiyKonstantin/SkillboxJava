...
public class DepositoryAccount extends Account {
    private Calendar dateOfLastDeposit;
    private Calendar dateOfEndBlocking;
    private SimpleDateFormat dateFormat = new SimpleDateFormat("dd.MM.yyyy 'и время' HH:mm:ss zzz");
